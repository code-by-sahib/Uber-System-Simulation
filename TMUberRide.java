...
public class TMUberRide extends TMUberService
{
  ...
  public TMUberRide(String from, String to, User user, int distance, double cost) // constructor for TMUberRide. Initializing values below
  {
    super(from, to, user, distance, cost, TMUberRide.TYPENAME); // calling the constructor of superclass to initialize
    requestedXL = false;
    numPassengers = 1;
  }
