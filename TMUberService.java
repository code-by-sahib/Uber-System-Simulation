...
abstract public class TMUberService implements Comparable<TMUberService>
{
  ...
  {
    TMUberService otherService = (TMUberService) other; // casting other to a TMUberService object
    return type.equals(otherService.type) && user.equals(otherService.user); // return true if type and user match. False otherwise
  }
